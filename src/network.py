...
algorithm for a feedforward neural network. Gradients are calcucated
...
class Network:
    def __init__(self, sizes):
        ...
        distribution with mean 0, and variance 1. Note the first
    ...
    def feedforward(self, a):
        ...
        Ex. for a network with sizes = [2, 3, 1], input a = np.array([[0.1], [2]])
        output would be an 1x1 array, like array([[0.86021862]]).
        """
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        for j in range(epochs):
            ...
            mini_batches = [training_data[k : k + mini_batch_size] for k in range(
                                0, n, mini_batch_size)]
    ...
    def backprop(self, x, y):
        ...
        # feedforward
        activation = x
        activations = [x]   # list to store all activations, layber by layer
